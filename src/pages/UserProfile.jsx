  ...
  return (
    <div className="min-h-screen bg-white px-52 pt-32">
      ...
      <div className="border-t border-gray-200 pt-8">
        ...
        {/* Add Email Button */}
        <button
          className="px-6 py-3 rounded-lg font-medium hover:opacity-80 transition-colors flex items-center space-x-2"
          style={{ backgroundColor: "#F9F9F9", color: "#17550B" }}
        >
          <svg
            className="w-5 h-5"
            fill="none"
